...
//		GUIContent fbAppNS = new GUIContent("FB app namespace:");
		...
		private ProfileSettings()
		{
			...
			twitterPaths.Add(compilationsRootPath + "/ios/ios-profile-twitter/libSTTwitter.a", "/iOS/libSTTwitter.a");
			twitterPaths.Add(compilationsRootPath + "/ios/ios-profile-twitter/libSoomlaiOSProfileTwitter.a", "/iOS/libSoomlaiOSProfileTwitter.a");
			twitterPaths.Add(compilationsRootPath + "/android/android-profile-twitter/AndroidProfileTwitter.jar", "/Android/AndroidProfileTwitter.jar");
			twitterPaths.Add(compilationsRootPath + "/android/android-profile-twitter/twitter4j-asyc-4.0.2.jar", "/Android/twitter4j-asyc-4.0.2.jar");
			twitterPaths.Add(compilationsRootPath + "/android/android-profile-twitter/twitter4j-core-4.0.2.jar", "/Android/twitter4j-core-4.0.2.jar");
			...
			googlePaths.Add(compilationsRootPath + "/ios/ios-profile-google/libSoomlaiOSProfileGoogle.a", "/iOS/libSoomlaiOSProfileGoogle.a");
			googlePaths.Add(compilationsRootPath + "/android/android-profile-google/AndroidProfileGoogle.jar", "/Android/AndroidProfileGoogle.jar");
			googlePaths.Add(GetGooglePlayServicesPath(), "/Android/google-play-services_lib");
...
//						}
						...
						foreach (var pathEntry in paths) {
							FileUtil.CopyFileOrDirectory(pathEntry.Key,
